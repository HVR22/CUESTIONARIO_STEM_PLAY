...
export default function FormularioEstimulo({ tipoTest = "pre" }) {
  ...
  const preguntas = [
    { texto: "1. Me gustaría aprender más del cuerpo humano", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    { texto: "2. Siento que la ingeniería es muy difícil para mí", etiquetas: ["Muy en desacuerdo", "En desacuerdo", "Neutral", "De acuerdo", "Muy de acuerdo"] },
    { texto: "3. Me divierte imaginar cómo funcionan las cosas por dentro", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    { texto: "4. Me pregunto muchas veces cómo funcionan las cosas en la naturaleza", etiquetas: ["Nada", "Poco", "Neutral", "Bastante", "Muchísimo"] },
    { texto: "5. Me gusta hacer experimentos o descubrir cosas nuevas", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    { texto: "6. A veces siento que la tecnología es complicada y no es para mí", etiquetas: ["Muy en desacuerdo", "En desacuerdo", "Neutral", "De acuerdo", "Muy de acuerdo"] },
    { texto: "7. Me gustaría saber cómo se crean los videojuegos o las aplicaciones", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    { texto: "8. Me emociona pensar en inventar algo usando tecnología", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    ...
    { texto: "10. Resolver problemas matemáticos me parece divertido", etiquetas: ["Muy en desacuerdo", "En desacuerdo", "Neutral", "De acuerdo", "Muy de acuerdo"] },
    { texto: "11. A veces las matemáticas me parecen confusas o aburridas", etiquetas: ["Muy en desacuerdo", "En desacuerdo", "Neutral", "De acuerdo", "Muy de acuerdo"] },
    { texto: "12. Me gustaría tener un trabajo en el futuro que use ciencia, tecnología o matemáticas", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    ...
    { texto: "15. Si tuviera que escoger ahora, elegiría una carrera donde pueda inventar, descubrir o resolver problemas", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    ...
    { texto: "17. Me gustaría usar las matemáticas para cosas reales, como hacer un presupuesto o diseñar algo", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    { texto: "18. Me gustaría ser parte de un equipo que crea algo nuevo, como un puente, una máquina o un robot", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] },
    ...
    { texto: "20. Me siento bien cuando logro entender algo difícil en matemáticas", etiquetas: ["No me gusta nada", "Poco", "Neutral", "Me gusta", "Me encanta"] }
  ];
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          {preguntas.map((pregunta, i) => (
            <div key={i} className="mb-4">
              ...
              {errors[`q${i + 1}`] && (
                <p className="text-danger mt-1 ms-1">⚠️ Falta responder la pregunta para que se envíe el formulario</p>
              )}
            </div>
          ))}
